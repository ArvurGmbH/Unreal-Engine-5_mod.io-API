...
UENUM(BlueprintType, DisplayName = "mod.io Platforms", Category = "mod.io API", meta = (Tooltip = "mod.io Supported Platforms"))
enum EModioAPI_Platforms
{
	Platforms_Source		UMETA(DisplayName = "Source (Source Files) - 'source'"),
	Platforms_Windows		UMETA(DisplayName = "Windows - 'windows'"),
	Platforms_Mac			UMETA(DisplayName = "Mac (Apple MacOS) - 'mac'"),
	Platforms_Linux			UMETA(DisplayName = "Linux - 'linux'"),
	Platforms_Android		UMETA(DisplayName = "Android - 'android'"),
	Platforms_iOS			UMETA(DisplayName = "iOS - 'ios'"),
	Platforms_XboxOne		UMETA(DisplayName = "Xbox One - 'xboxone'"),
	Platforms_XboxSeriesX	UMETA(DisplayName = "Xbox Series X - 'xboxseriesx'"),
	Platforms_PlayStation4	UMETA(DisplayName = "PlayStation 4 - 'ps4'"),
	Platforms_PlayStation5	UMETA(DisplayName = "PlayStation 5 - 'ps5'"),
	Platforms_Switch		UMETA(DisplayName = "Nintendo Switch - 'switch'"),
	Platforms_Oculus		UMETA(DisplayName = "Meta Quest (Android) - 'oculus'"),
};
...
UENUM(BlueprintType, DisplayName = "mod.io Download Result", Category = "mod.io API|Download", meta = (Tooltip = "The Result of a Download"))
enum EModioAPI_DownloadResult
{
	DownloadResult_Running						UMETA(DisplayName = "Running"),
	DownloadResult_CompletedSuccessfully		UMETA(DisplayName = "Success"),
	DownloadResult_Paused						UMETA(DisplayName = "Paused"),
	DownloadResult_Cancelled					UMETA(DisplayName = "Cancelled"),
	DownloadResult_CompletedFailed				UMETA(DisplayName = "Failed"),
};

/*
UENUM()
enum EModioAPI_DownloadInputAction
{
	DownloadInputAction_Start				UMETA(DisplayName = "Start"),
	DownloadInputAction_Pause				UMETA(DisplayName = "Pause"),
